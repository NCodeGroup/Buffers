...
public class FixedSpanBufferWriterTests
{
    ...
    [Fact]
    public void GetSpan_WritesCorrectlyToBuffer()
    {
        var buffer = new byte[100];
        var writer = new FixedSpanBufferWriter<byte>(buffer);
    ...
    public void GenericType_Long_Works()
    {
        ...
        var writer = new FixedSpanBufferWriter<long>(buffer);
    ...
    {
        Span<double> buffer = stackalloc double[10];
        var writer = new FixedSpanBufferWriter<double>(buffer);
